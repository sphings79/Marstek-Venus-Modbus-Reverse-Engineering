...
| `VNSD-0` | Venus D | — (kein OTA-Eintrag, siehe unten) |
...
| Firmware-Typ | Beschreibung | Beispiel VNSA-0 |
|---|---|---|
| Control (EMS) | Haupt-Controller-Firmware | v1487 |
| BMS | Battery Management System | v1105 |
| Inverter (micro) | Wechselrichter-Firmware | v1193 |
| MPPT | Solar-Laderegler (falls vorhanden) | — |

**Anpassungen dieser Instanz gegenüber dem Original:**

- Unterstützt `VNSD-0` (Venus D), `VNSA-0` (Venus A) und `VNSE3-0` (Venus E V3)
...
> **VNSD-0 (Venus D):** Der OTA-Server liefert für diesen Gerätetyp keine
> Firmware — `VNSD-0` ist im Marstek-System nicht registriert. Die Firmware
> (`VNSEE3-0`) muss auf anderem Weg beschafft werden (siehe Option B).
...
*Rev 9: Firmware-Beschaffung um Self-Hosted FW Checker Tool ergänzt*
